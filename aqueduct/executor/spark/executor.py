...
-- query (`report --profile --blueprint <id> --last N`). Deliberately
-- duplicated from `executor/models.py`'s MODULE_METRICS_DDL (see this
-- module's docstring for why) — keep both copies in sync.
