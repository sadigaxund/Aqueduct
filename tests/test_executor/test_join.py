...
class TestJoinOperation:
    def test_join_missing_left(self, spark: SparkSession):
        module = Module(
            ...
            type="Channel",
            label="C",
            config={"op": "join", "right": "source_b", "condition": "a.id = b.id"},
        )
    ...
    def test_join_missing_right(self, spark: SparkSession):
        module = Module(
            ...
            type="Channel",
            label="C",
            config={"op": "join", "left": "source_a", "condition": "a.id = b.id"},
        )
    ...
    def test_join_invalid_type(self, spark: SparkSession):
        module = Module(
            ...
            type="Channel",
            label="C",
            config={"op": "join", "left": "source_a", "right": "source_b", "join_type": "invalid"},
        )
    ...
    def test_join_missing_condition(self, spark: SparkSession):
        module = Module(
            ...
            type="Channel",
            label="C",
            config={"op": "join", "left": "source_a", "right": "source_b", "join_type": "inner"},
        )
    ...
    def test_join_cross_no_condition(self, spark: SparkSession):
        ...
        module = Module(
            ...
            type="Channel",
            label="C",
            config={"op": "join", "left": "a", "right": "b", "join_type": "cross"},
        )
    ...
    def test_join_end_to_end(self, spark, tmp_path):
        ...
        spark.range(1, 3).selectExpr(
            "id as id1", "case when id=1 then 'A' else 'B' end as name"
        ).write.parquet(p1)
...
class TestChannelJoinQuery:
    ...
    def test_left_join(self):
        ...
        q = _build_join_query(
            "m", {"left": "a", "right": "b", "join_type": "left", "condition": "a.id = b.id"}
        )
    ...
    def test_broadcast_right(self):
        ...
        q = _build_join_query(
            "m", {"left": "a", "right": "b", "condition": "a.id = b.id", "broadcast_side": "right"}
        )
    ...
    def test_broadcast_left(self):
        ...
        q = _build_join_query(
            "m", {"left": "a", "right": "b", "condition": "a.id = b.id", "broadcast_side": "left"}
        )
    ...
    def test_invalid_join_type_raises(self):
        ...
        with pytest.raises(ChannelError, match="invalid join_type"):
            _build_join_query(
                "m", {"left": "a", "right": "b", "join_type": "outer", "condition": "x"}
            )
