...
class PrefixRedisDepotStore:
    ...
    def location_label(self):
        return self._store.location_label

    def kv_get(self, key, default=""):
        return self._store.kv_get(self._prefix + key, default)

    def kv_put(self, key, value):
        self._store.kv_put(self._prefix + key, value)

    def kv_delete(self, key):
        self._store.kv_delete(self._prefix + key)
