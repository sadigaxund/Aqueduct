...
def main():
    ...
    t = Table(title="Masked User Data (SQL UDF)", header_style="bold cyan")
    for c in df.columns:
        t.add_column(c)
    ...
    console.print("\n[dim]The SQL UDF masks email addresses using a Python function registered with the engine.[/dim]")
