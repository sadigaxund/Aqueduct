...
def main():
    ...
    console.print("[bold green]✓[/bold green] Funnel merge complete! Gaps filled.\n")
    ...
    console.print(
        "[dim]  Note: User 2's email was NULL in primary but was filled from the fallback stream.[/dim]"
    )
    console.print(
